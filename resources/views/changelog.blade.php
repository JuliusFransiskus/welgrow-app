...
<link rel="stylesheet" href="./assets/css/theme.min.css">
   ...
   <meta name="description" content="Changelog - TailwindCSS HTML Admin Template Free - Dash UI" />
   <title>Changelog - TailwindCSS HTML Admin Template Free - Dash UI</title>
</head>
...
<!-- end of navbar -->
            ...
            <div class="p-6">
               ...
               <div class="flex flex-col mb-4 border-b border-gray-300 pb-4">
                  <!-- title -->
                  <h1 class="block font-semibold leading-6 text-xl mb-1">Changelog</h1>
                  <p class="text-lg">Keep a changelog. All notable changes to this project will be documented in this
                     file.</p>
               </div>
               <div class="grid lg:grid-cols-9 gap-4 grid-cols-2 md:grid-cols-4">
                  <div class="md:col-span-2 col-span-1">
                     <code class="text-red-600">v1.1.0 - January 1, 2024</code>
                  </div>
                  <div class="md:col-span-2 col-span-1">
                     <span>Intial Release</span>
                  </div>
               </div>
            </div>
            <footer>
