...
<html lang="en">
   <head>
      ...
      <title>Invoice Generator - TailwindCSS HTML5 Admin Dashboard Template</title>
   </head>
   <body>
      <main>
         <!-- start the project -->
            ...
            <nav class="navbar-vertical navbar">
               <div id="myScrollableElement" class="h-screen" data-simplebar>
                  ...
                  <ul class="navbar-nav flex-col" id="sideNavbar">
                     ...
                     <!-- Nav item -->
                     <li class="nav-item">
                        <a class="nav-link" href="#!" data-bs-toggle="collapse" data-bs-target="#navinvoice" aria-expanded="false" aria-controls="navinvoice">
                        ...
                        <div id="navinvoice" class="collapse show" data-bs-parent="#sideNavbar">
                           <ul class="nav flex-col">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link active" href="./invoice-generator.html">Invoice Generator</a>
                              </li>
                           </ul>
                        </div>
                     </li>
                     ...
                     <!-- nav item -->
                     <li class="nav-item">
                        <a class="nav-link collapsed" href="#!" data-bs-toggle="collapse" data-bs-target="#navlayoutPage" aria-expanded="false" aria-controls="navlayoutPage">
