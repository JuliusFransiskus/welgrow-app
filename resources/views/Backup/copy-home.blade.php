...
<head>
   ...
   <link rel="shortcut icon" type="image/x-icon" href="public/dashui/dist/assets/images/favicon/favicon.ico" />

   <!-- Libs CSS -->
   <link rel="preconnect" href="https://fonts.googleapis.com" />
   <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
   <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap" />
   <link rel="stylesheet" href="{{ asset('template/dashui/dist') }}/assets/libs/simplebar/dist/simplebar.min.css" />

   <!-- Theme CSS -->
   <link rel="stylesheet" href="{{ asset('template/dashui/dist') }}/assets/css/theme.min.css">

      <link rel="stylesheet" href="{{ asset('template/dashui/dist') }}/assets/libs/apexcharts/dist/apexcharts.css" />
            ...
            <nav class="navbar-vertical navbar">
               <div id="myScrollableElement" class="h-screen" data-simplebar>
                  ...
                  <a class="navbar-brand" href="{{ asset('template/dashui/dist') }}/index.html">
                     <img src="{{ asset('template/dashui/dist') }}/assets/images/brand/logo/logo.svg" alt="" />
                  </a>
                           ...
                           <table class="text-left w-full whitespace-nowrap">
                              ...
                              <tbody>
                                 <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="flex items-center">
                                          <img src="{{ asset('template/dashui/dist') }}/assets/images/svg/brand-logo-1.svg" alt="" class="h-6 w-6" />
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="-space-x-5">
                                          <img
                                             ...
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-1.jpg" alt="Profile image" />
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-2.jpg" alt="Profile image" />
                                          <img
                                 ...
                                 <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="flex items-center">
                                          <img src="{{ asset('template/dashui/dist') }}/assets/images/svg/brand-logo-2.svg" alt="" class="h-6 w-6" />
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="-space-x-5">
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-4.jpg" alt="Profile image" />
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-5.jpg" alt="Profile image" />
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 border-2 rounded-full border-white"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-6.jpg" alt="Profile image" />
                                          <div
                                             class="relative w-8 h-8 bg-indigo-600 rounded-full inline-flex items-center justify-center text-white text-sm border-2 border-white">
                                             2+</div>
                                       </div>
                                 ...
                                 <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="flex items-center">
                                          <img src="{{ asset('template/dashui/dist') }}/assets/images/svg/brand-logo-3.svg" alt="" class="h-6 w-6" />
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="-space-x-5">
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-7.jpg" alt="Profile image" />
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-8.jpg" alt="Profile image" />
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 border-2 rounded-full border-white"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-9.jpg" alt="Profile image" />
                                          <div
                                             class="relative w-8 h-8 bg-indigo-600 rounded-full inline-flex items-center justify-center text-white text-sm border-2 border-white">
                                             5+</div>
                                       </div>
                                 ...
                                 <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="flex items-center">
                                          <img src="{{ asset('template/dashui/dist') }}/assets/images/svg/brand-logo-4.svg" alt="" class="h-6 w-6" />
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="-space-x-5">
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-10.jpg" alt="Profile image" />
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-11.jpg" alt="Profile image" />
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 border-2 rounded-full border-white"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-12.jpg" alt="Profile image" />
                                          <div
                                             class="relative w-8 h-8 bg-indigo-600 rounded-full inline-flex items-center justify-center text-white text-sm border-2 border-white">
                                             5+</div>
                                       </div>
                                 ...
                                 <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="flex items-center">
                                          <img src="{{ asset('template/dashui/dist') }}/assets/images/svg/brand-logo-5.svg" alt="" class="h-6 w-6" />
                                    ...
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="-space-x-5">
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-13.jpg" alt="Profile image" />
                                          <img
                                             class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                                             src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-11.jpg" alt="Profile image" />
                                          <img
                                 ...
                                 <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="flex items-center">
                                          <img src="{{ asset('template/dashui/dist') }}/assets/images/svg/brand-logo-6.svg" alt="" class="h-6 w-6" />
                                 ...
                                 <tr>
                                    <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                       <div class="flex items-center">
                                          ...
                                          <label for="checkboxSeven" class="text-base ml-2 text-slate-600">Develop a Dash
                                             UI Laravel</label>
                                       </div>
                                    </td>
                        ...
                        <table class="text-left w-full whitespace-nowrap">
                           ...
                           <tbody>
                              <tr>
                                    ...
                                    <div class="flex items-center">
                                       <div>
                                          <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-2.jpg" alt="Image"
                                 ...
                                 <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Front End Developer
                                 </td>
                                    ...
                                    <div class="flex items-center">
                                       <div>
                                          <a href="#!" class="h-10 w-10 inline-block">
                                             <img src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-3.jpg" alt="Image"
                                                class="rounded-full" />
                                          </a>
                                       </div>
                                       <div class="ml-3 leading-4">
                              ...
                              <tr>
                                 ...
                                 <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Full- Stack Developer
                                 </td>
                                 <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Yesterday</td>
                                 <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="dropdown leading-4">
                              ...
                              <tr>
                                 <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                       <div>
                                          <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-5.jpg" alt="Image"
                                                class="rounded-full" /></a>
                                       </div>
                                       <div class="ml-3 leading-4">
                              ...
                              <tr>
                                 <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                       <div>
                                          <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-6.jpg" alt="Image"
                                                class="rounded-full" /></a>
                                       </div>
                                       <div class="ml-3 leading-4">
                              ...
                              <tr>
                                 <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                       <div>
                                          <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-7.jpg" alt="Image"
                                                class="rounded-full" /></a>
                                       </div>
                                       <div class="ml-3 leading-4">
                              ...
                              <tr>
                                 <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                       <div>
                                          <a href="#!" class="h-10 w-10 inline-block"><img
                                                src="{{ asset('template/dashui/dist') }}/assets/images/avatar/avatar-8.jpg" alt="Image"
                                                class="rounded-full" /></a>
                                       </div>
                                       <div class="ml-3 leading-4">
                                          <h5 class="mb-1"><a href="#!">Patricia Murrill</a></h5>
