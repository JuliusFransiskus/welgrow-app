...
<div class="p-6" x-data="customerApp()">

    <div class="flex items-center mb-4 border-b border-gray-300 pb-4">
        <h1 class="inline-block text-xl font-semibold leading-6">Customer</h1>
    </div>
                    ...
                    <table class=" w-full whitespace-nowrap">
                        ...
                        <tbody class="divide-y">
                            ...
                            <tr 
                                ...
                                :class="selected?.id === {{ $customer->id }} ? 'bg-gray-200' : ''"
                                @click="selected = {
                                    id: '{{ $customer->id ?? ''}}',
                                    code: '{{ $customer->code ?? '' }}',
                                    name: '{{ $customer->name ?? '' }}',
...
<nav class="flex items-center gap-x-1 mt-4">
    ...
    <a href="{{ $customers->previousPageUrl() }}"
       class="min-h-[36px] min-w-[36px] py-2 px-2.5 inline-flex justify-center items-center gap-x-1.5 rounded-md border bg-white border-gray-300 text-gray-800 hover:bg-gray-300 {{ $customers->onFirstPage() ? 'opacity-50 pointer-events-none' : '' }}">
        <span>Previous</span>
    </a>
    ...
    <a href="{{ $customers->nextPageUrl() }}"
       class="min-h-[36px] min-w-[36px] py-2 px-2.5 inline-flex justify-center items-center gap-x-1.5 rounded-md border bg-white border-gray-300 text-gray-800 hover:bg-gray-300 {{ $customers->hasMorePages() ? '' : 'opacity-50 pointer-events-none' }}">
        <span>Next</span>
    </a>
...
@endif
        ...
        <div class="card shadow xl:col-span-1">
            <div class="card-body">
                ...
                <template x-if="!selected">
                    <p class="text-gray-500 mt-4">Klik customer untuk melihat detail.</p>
                </template>
