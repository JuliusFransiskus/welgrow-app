...
<div class="p-6">
    <div class="flex items-center mb-4 border-b border-gray-300 pb-4">
        <!-- title -->
        <h1 class="inline-block text-xl font-semibold leading-6">Edit Customer</h1>
    </div>
                ...
                <form method="POST" action="{{ route('customers.update', $customer->id) }}">
                    ...
                    <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
                        ...
                        <select name="type"
                            ...
                            <option value="1"
                            {{ old('type', $customer->type) == '1' ? 'selected' : '' }}>
                            Customer</option>
                            <option value="2"
                            {{ old('type', $customer->type) == '2' ? 'selected' : '' }}>
                            Vendor</option>
                            <option value="3"
                            {{ old('type', $customer->type) == '3' ? 'selected' : '' }}>
                            Agent</option>
                        </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
                        ...
                        <div class="flex-[3]">
                            <textarea 
                                ...
                                id="address" 
                                required="" 
                                name="address">{{ old('address', $customer->address) }}
                            </textarea>
                        </div>
                    </div>
                    <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
