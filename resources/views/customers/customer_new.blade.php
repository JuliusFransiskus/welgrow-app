...
<div class="p-6">
    <div class="flex items-center mb-4 border-b border-gray-300 pb-4">
        <!-- title -->
        <h1 class="inline-block text-xl font-semibold leading-6">Add New Customer</h1>
    </div>
            ...
            <div>
                <form method="POST" action="{{ route('customers.store') }}">
                    ...
                    <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
                        <label for="code" class="flex-1 text-gray-800 font-semibold">Customer Code</label>
                        ...
                        <input type="text"
                            ...
                            placeholder="Customer Code" id="code" required="" name="code" />
                        </div>
                    </div>
                    <!-- Name -->
                    <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
                        <label for="name" class="flex-1 text-gray-800 font-semibold">Customer Name</label>
                        <div class="flex-[3] w-full">
                        <input type="text"
                            class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3 disabled:opacity-50 disabled:pointer-events-none"
                            placeholder="Customer Name" id="name" required="" name="name" />
                        </div>
                    </div>
                    <!-- Tax ID -->
                    <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
                    ...
                    <div class="mb-6 inline-flex md:flex md:items-center gap-3 flex-col md:flex-row w-full">
                        ...
                        <div class="flex-[3] w-full">
                        <select name="type"
                            class="flex-1 text-base border border-gray-300 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3 disabled:opacity-50 disabled:pointer-events-none"
                            id="type">
